...
$(document).ready(function() {
    ...
    createTable($("#statisticsTable"), {"supportsControllersDiscrimination": true, "overall": {"data": ["Total", 10000, 0, 0.0, 2889.8834000000115, 2571, 14350, 2600.0, 3248.2999999999975, 5197.0, 7795.0, 27.0526905253362, 1.003908437463648, 3.8042846051254027], "isController": false}, "titles": ["Label", "#Samples", "FAIL", "Error %", "Average", "Min", "Max", "Median", "90th pct", "95th pct", "99th pct", "Transactions/s", "Received", "Sent"], "items": [{"data": ["HTTP Request", 10000, 0, 0.0, 2889.8834000000115, 2571, 14350, 2600.0, 3248.2999999999975, 5197.0, 7795.0, 27.0526905253362, 1.003908437463648, 3.8042846051254027], "isController": false}]}, function(index, item){
        switch(index){
            // Errors pct
            case 3:
                item = item.toFixed(2) + '%';
