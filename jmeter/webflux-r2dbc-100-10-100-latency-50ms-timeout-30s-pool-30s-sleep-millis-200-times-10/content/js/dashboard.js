...
$(document).ready(function() {
    ...
    createTable($("#statisticsTable"), {"supportsControllersDiscrimination": true, "overall": {"data": ["Total", 10000, 0, 0.0, 2834.383199999997, 2673, 3046, 2841.0, 2939.8999999999996, 2951.0, 2997.0, 34.086532070313694, 1.2649299010467976, 4.793418572387864], "isController": false}, "titles": ["Label", "#Samples", "FAIL", "Error %", "Average", "Min", "Max", "Median", "90th pct", "95th pct", "99th pct", "Transactions/s", "Received", "Sent"], "items": [{"data": ["HTTP Request", 10000, 0, 0.0, 2834.383199999997, 2673, 3046, 2841.0, 2939.8999999999996, 2951.0, 2997.0, 34.086532070313694, 1.2649299010467976, 4.793418572387864], "isController": false}]}, function(index, item){
        switch(index){
            // Errors pct
            case 3:
                item = item.toFixed(2) + '%';
