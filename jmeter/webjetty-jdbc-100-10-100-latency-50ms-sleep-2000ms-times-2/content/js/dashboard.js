...
$(document).ready(function() {
    ...
    createTable($("#statisticsTable"), {"supportsControllersDiscrimination": true, "overall": {"data": ["Total", 10000, 0, 0.0, 4336.915899999991, 4153, 13151, 4160.0, 4180.0, 4511.949999999999, 10704.97, 22.613843742862507, 1.6562873835104375, 3.1800717763400397], "isController": false}, "titles": ["Label", "#Samples", "FAIL", "Error %", "Average", "Min", "Max", "Median", "90th pct", "95th pct", "99th pct", "Transactions/s", "Received", "Sent"], "items": [{"data": ["HTTP Request", 10000, 0, 0.0, 4336.915899999991, 4153, 13151, 4160.0, 4180.0, 4511.949999999999, 10704.97, 22.613843742862507, 1.6562873835104375, 3.1800717763400397], "isController": false}]}, function(index, item){
        switch(index){
            // Errors pct
            case 3:
                item = item.toFixed(2) + '%';
