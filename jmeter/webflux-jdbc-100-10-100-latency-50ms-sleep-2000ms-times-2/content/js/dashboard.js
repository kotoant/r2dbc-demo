...
$(document).ready(function() {
    ...
    createTable($("#statisticsTable"), {"supportsControllersDiscrimination": true, "overall": {"data": ["Total", 10000, 0, 0.0, 4373.617799999996, 4153, 12955, 4203.0, 4314.0, 4544.7499999999945, 10549.819999999996, 22.439284904868654, 0.8327078382666101, 3.155524439747154], "isController": false}, "titles": ["Label", "#Samples", "FAIL", "Error %", "Average", "Min", "Max", "Median", "90th pct", "95th pct", "99th pct", "Transactions/s", "Received", "Sent"], "items": [{"data": ["HTTP Request", 10000, 0, 0.0, 4373.617799999996, 4153, 12955, 4203.0, 4314.0, 4544.7499999999945, 10549.819999999996, 22.439284904868654, 0.8327078382666101, 3.155524439747154], "isController": false}]}, function(index, item){
        switch(index){
            // Errors pct
            case 3:
                item = item.toFixed(2) + '%';
